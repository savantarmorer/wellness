...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: 'Avaliação Diária', icon: <AssessmentIcon />, path: '/daily-assessment' },
    { text: 'Estatísticas', icon: <TrendingUp />, path: '/statistics' },
    { text: 'Histórico de Análises', icon: <History />, path: '/analysis-history' },
