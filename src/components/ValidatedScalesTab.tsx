    ...
    <Box sx={{ p: 2 }}>
      ...
      <Paper elevation={3} sx={{ p: 2, mb: 3 }}>
        ...
        <Grid container spacing={2}>
          {Object.entries(analysis.das).map(([key, value]) => (
      ...
      <Paper elevation={3} sx={{ p: 2, mb: 3 }}>
        ...
        <Grid container spacing={2}>
          {Object.entries(analysis.csi).map(([key, value]) => (
            <Grid item xs={12} key={key}>
              <Box sx={{ mb: 2 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Typography variant="body2" sx={{ flexGrow: 1 }}>
      ...
      <Paper elevation={3} sx={{ p: 2, mb: 3 }}>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          {Object.entries(analysis.gottman.fourHorsemen).map(([key, value]) => (
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          {Object.entries(analysis.gottman.bidsForConnection).map(([key, value]) => (
            <Grid item xs={12} sm={6} key={key}>
              <Box sx={{ mb: 2 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Typography variant="body2" sx={{ flexGrow: 1 }}>
        ...
        <Grid container spacing={2}>
          {Object.entries({
            resolucaoConflitos: analysis.gottman.resolucaoConflitos,
            significadoCompartilhado: analysis.gottman.significadoCompartilhado,
            reparacao: analysis.gottman.reparacao,
            influenciaPositiva: analysis.gottman.influenciaPositiva
          }).map(([key, value]) => (
            <Grid item xs={12} sm={6} key={key}>
              <Box sx={{ mb: 2 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
